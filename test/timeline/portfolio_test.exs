defmodule Timeline.PortfolioTest do
  ...
  test "allocate portfolio" do
    portfolio =
      allocate_portfolio(1000, %{"AAPL" => 50, "GOOGL" => 25, "VTI" => 25}, %{
        "AAPL" => 1,
        "GOOGL" => 1,
        "VTI" => 1
      })
  ...
  test "calculate portfolio value" do
    ...
    portfolio_value =
      calculate_portfolio_value(portfolio, %{"AAPL" => 2, "GOOGL" => 2, "VTI" => 2})

    assert portfolio_value == 2000
  end

  test "calculate portfolio values" do
    {:ok, portfolio_values, _} =
      calculate_timeline(1000, %{"AAPL" => 50, "GOOGL" => 25, "VTI" => 25}, ~D[2005-10-10])
  ...
  test "calculate portfolio values with errors" do
    {:err, errors} =
      calculate_timeline(
        1000,
        %{"AAPL" => 50, "GOOGLSdas1321" => 25, "VTI" => 25},
        ~D[2005-10-10]
      )
